...
# and mitmproxy logs a startup error and exits. Serialising bring-up end to end
# -- construction through the running() phase -- is the only thing that makes
# more than one in-process capture safe.
