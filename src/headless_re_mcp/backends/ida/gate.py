...
def run_idalib_gate(
    ...
    *,
    ...
    try:
        ...
        # of the process life.
        timed_out = True
        # One cleanup budget covers tree termination, the pipe drain, and the
        # monitor join below.  Stacking a five-second drain on a two-second
        # join let a 100 ms gate bound take over seven seconds.
