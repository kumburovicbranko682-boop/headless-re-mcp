...
class ApkClient:
    ...
    def certificates(self, path: Path) -> JsonObject:
        ...
        # and rely on APK Signature Scheme v2/v3, so reporting only v1_signed
        # made a fully-signed app read as unsigned. get_certificates already
        # unions v1/v2/v3 certs; name the scheme each was found under too.
