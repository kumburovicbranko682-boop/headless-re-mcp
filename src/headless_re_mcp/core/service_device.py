...
# 256 KiB left 20.0 MiB that nothing could reclaim. The directory is instead
# bounded in place by prune_capped_dir (UNREGISTERED_CAPTURE_MAX_ENTRIES /
# UNREGISTERED_CAPTURE_MAX_BYTES), which caps both file count and total bytes.
