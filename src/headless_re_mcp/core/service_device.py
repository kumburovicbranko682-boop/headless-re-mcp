...
# session_id, so retention never sees them. The directory itself is the bound --
# every call runs prune_capped_dir over it (keeping the newest
# UNREGISTERED_CAPTURE_MAX_ENTRIES and staying under UNREGISTERED_CAPTURE_MAX_BYTES)
# and refuses any single file over the cap. Measured before that bound existed: 80
# screenshots of 256 KiB left 20.0 MiB that nothing could reclaim.
