...
# session_id. Retention therefore never sees them, so the directory itself is
# the bound -- prune_capped_dir(UNREGISTERED_CAPTURE_MAX_ENTRIES, _BYTES) evicts
# the oldest captures after every write. Measured before the cap: 80 screenshots
# of 256 KiB left 20.0 MiB that nothing could reclaim.
