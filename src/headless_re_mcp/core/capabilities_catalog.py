...
_CORE_CAPABILITIES: tuple[JsonObject, ...] = (
    ...
    },
    {
        ...
        "tools": ["r2.open", "r2.info", "r2.functions", "r2.strings", "r2.imports", "r2.exports", "r2.sections", "r2.symbols", "r2.entrypoints", "r2.disasm", "r2.disasm_function", "r2.xrefs", "r2.read", "r2.search", "r2.libs"],
