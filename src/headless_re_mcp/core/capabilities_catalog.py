...
_CORE_CAPABILITIES: tuple[JsonObject, ...] = (
    ...
    },
    {
        ...
        "tools": ["r2.open", "r2.info", "r2.functions", "r2.strings", "r2.strings_all", "r2.imports", "r2.exports", "r2.sections", "r2.symbols", "r2.entrypoints", "r2.disasm", "r2.disasm_function", "r2.xrefs", "r2.read", "r2.search", "r2.libs", "r2.relocations", "r2.resolve", "r2.callgraph", "r2.cfg"],
    ...
    },
    {
        ...
        "tools": ["apk.open", "apk.manifest", "apk.permissions", "apk.classes", "apk.class_summary", "apk.subclasses", "apk.class_xrefs", "apk.methods", "apk.method_bytecode", "apk.method_cfg", "apk.method_refs", "apk.method_xrefs", "apk.fields", "apk.strings", "apk.xrefs", "apk.string_xrefs", "apk.field_xrefs", "apk.extract_native_lib"],
    ...
    },
    {
        ...
        "tools": ["web.open", "web.navigate", "web.network.list", "web.network.endpoints", "web.network.secrets", "web.network.get", "web.ws.list", "web.ws.frames", "web.cookies", "web.storage", "web.frames", "web.scripts", "web.script.source", "web.screenshot"],
    ...
    },
    {
        ...
        "backend": "web",
        "status_probe": "wabt",
        "tools": ["wasm.decompile", "wasm.info", "wasm.wat", "wasm.summary", "wasm.functions", "wasm.disasm_function", "wasm.names", "wasm.strings", "wasm.data", "wasm.memory", "wasm.globals", "wasm.elements"],
    ...
    },
    {
        ...
        "tools": ["proxy.start", "proxy.flows", "proxy.stats", "proxy.endpoints", "proxy.search", "proxy.secrets", "proxy.flow.get", "proxy.ws.frames", "proxy.ws.search", "proxy.replay", "proxy.export_har", "proxy.ca.install_android"],
