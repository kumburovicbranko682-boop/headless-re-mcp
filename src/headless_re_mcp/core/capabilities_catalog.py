...
_CORE_CAPABILITIES: tuple[JsonObject, ...] = (
    ...
    },
    {
        ...
        "tools": ["web.open", "web.navigate", "web.network.list", "web.network.endpoints", "web.network.get", "web.ws.list", "web.ws.frames", "web.cookies", "web.storage", "web.frames", "web.scripts", "web.script.source", "web.screenshot"],
