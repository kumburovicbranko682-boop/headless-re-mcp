...
_CORE_CAPABILITIES: tuple[JsonObject, ...] = (
    ...
    },
    {
        ...
        "tools": ["apk.open", "apk.manifest", "apk.permissions", "apk.certificates", "apk.components", "apk.native_libs", "apk.classes", "apk.methods", "apk.strings", "apk.xrefs"],
    ...
    },
    {
        ...
        "summary": "apktool decode/rebuild for APK editing (requires a JRE)",
        "optional": True,
    },
    {
        # apk.sign runs through apksigner, a separate binary with its own
        # HEADLESS_RE_APKSIGNER setting and its own doctor probe -- installable
        # independently of apktool. Folded into apk.apktool (status_probe
        # "apktool"), a host with apktool but not apksigner reported this
        # capability ready while apk.sign answered capability_unavailable. Its
        # own capability keyed on the apksigner probe makes the readout honest.
        "id": "apk.apksigner",
        "backend": "apk",
    ...
    },
    {
        ...
        "tools": ["device.list", "device.connect", "device.info", "device.properties", "device.packages", "device.install", "device.uninstall", "device.launch", "device.force_stop", "device.current_activity", "device.logcat", "device.screenshot", "device.pull", "device.push", "device.forward"],
    ...
    },
    {
        ...
        "backend": "frida",
        "status_probe": "frida",
        "tools": ["frida.devices", "frida.device.connect", "frida.server.ensure", "frida.applications", "frida.spawn", "frida.java.classes", "frida.java.methods"],
    ...
    },
    {
        ...
        "tools": ["web.open", "web.navigate", "web.close", "web.network.list", "web.network.get", "web.console", "web.scripts", "web.script.source", "web.wasm.list", "web.dom.snapshot", "web.screenshot", "web.har.export"],
    ...
    },
    {
        ...
        "tools": ["proxy.start", "proxy.status", "proxy.stop", "proxy.flows", "proxy.flow.get", "proxy.replay", "proxy.export_har", "proxy.ca.install_android"],
