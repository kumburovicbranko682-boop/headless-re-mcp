...
_CORE_CAPABILITIES: tuple[JsonObject, ...] = (
    ...
    },
    {
        ...
        "tools": ["r2.open", "r2.info", "r2.functions", "r2.strings", "r2.imports", "r2.exports", "r2.sections", "r2.symbols", "r2.entrypoints", "r2.disasm", "r2.disasm_function", "r2.xrefs", "r2.read", "r2.search", "r2.libs", "r2.relocations"],
    ...
    },
    {
        ...
        "tools": ["apk.open", "apk.manifest", "apk.permissions", "apk.classes", "apk.class_summary", "apk.subclasses", "apk.methods", "apk.method_bytecode", "apk.method_refs", "apk.fields", "apk.strings", "apk.xrefs", "apk.string_xrefs", "apk.field_xrefs", "apk.extract_native_lib"],
    ...
    },
    {
        ...
        "backend": "web",
        "status_probe": "wabt",
        "tools": ["wasm.decompile", "wasm.info", "wasm.wat", "wasm.summary", "wasm.names", "wasm.strings"],
    ...
    },
    {
        ...
        "tools": ["proxy.start", "proxy.flows", "proxy.stats", "proxy.search", "proxy.flow.get", "proxy.ws.frames", "proxy.replay", "proxy.export_har", "proxy.ca.install_android"],
