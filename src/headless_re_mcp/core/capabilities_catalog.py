...
_CORE_CAPABILITIES: tuple[JsonObject, ...] = (
    ...
    },
    {
        ...
        "tools": ["r2.open", "r2.info", "r2.functions", "r2.strings", "r2.imports", "r2.exports", "r2.sections", "r2.symbols", "r2.entrypoints", "r2.disasm", "r2.xrefs"],
    ...
    },
    {
        ...
        "tools": ["apk.open", "apk.manifest", "apk.permissions", "apk.classes", "apk.methods", "apk.strings", "apk.xrefs", "apk.string_xrefs", "apk.field_xrefs"],
    ...
    },
    {
        ...
        "tools": ["web.open", "web.navigate", "web.network.list", "web.network.get", "web.ws.list", "web.ws.frames", "web.scripts", "web.script.source", "web.screenshot"],
