...
class UiAutomationMixin:
    ...
    def ui_screenshot(
        ...
        *,
        ...
        # Validate the session id (which is used as a path segment) before the
        # platform gate so a traversal attempt is always rejected as
        # invalid_request, never leaking through as unsupported_on_platform.
