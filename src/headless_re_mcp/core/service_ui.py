...
class UiAutomationMixin:
    ...
    def ui_screenshot(
        ...
        *,
        ...
        # Validate the session id before the platform gate so a path-traversal
        # attempt is rejected the same way on every OS, rather than being masked
        # by "unsupported on this platform" where the capture never runs.
