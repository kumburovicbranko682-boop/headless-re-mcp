...
class UiAutomationMixin:
    ...
    def ui_screenshot(
        ...
        *,
        ...
        # Validate the untrusted session id before the platform gate: a path that
        # would escape artifact_root must be rejected as invalid_request on every
        # platform, not masked behind unsupported_on_platform off Windows.
