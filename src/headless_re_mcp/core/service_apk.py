...
class ApkAnalysisMixin:
    ...
    def apk_certificates(self, session_id: str, limit: int = 32) -> Result[JsonObject]:
        try:
            binary = self._apk_binary(session_id)
    ...
    def apk_components(self, session_id: str, limit: int = 1000) -> Result[JsonObject]:
        try:
            binary = self._apk_binary(session_id)
    ...
    def apk_native_libs(self, session_id: str, limit: int = 1000) -> Result[JsonObject]:
        try:
            binary = self._apk_binary(session_id)
