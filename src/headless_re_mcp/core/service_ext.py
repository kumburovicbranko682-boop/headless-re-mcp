...
class ExtAnalysisMixin(UiDriveMixin):
    ...
    def ghidra_segments(
        ...
        return _ghidra_export(self, session_id, "segments", limit=limit, timeout=timeout)
    ...
    *,
    ...
    try:
        ...
        if mode == "functions":
            ...
            data = client.segments(session.require_binary(), project, limit=limit, timeout=timeout)
        elif mode == "xrefs":
            if address is None:
