...
from headless_re_mcp.backends.jsre import JsClient, JsReError, WasmClient, scan_sinks
...
class JsReAnalysisMixin:
    ...
    def js_sinks(self, path: str) -> Result[JsonObject]:
        try:
            data = scan_sinks(Path(path))
