...
class ProxyAnalysisMixin:
    ...
    def proxy_hosts(self, session_id: str, offset: int = 0, limit: int = 200) -> Result[JsonObject]:
        return self._proxy_wrap(session_id, "hosts", session_id, offset=offset, limit=limit)
