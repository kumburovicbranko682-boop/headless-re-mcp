...
def build_web_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def web_network_list(
        ...
        """List captured network requests (check has_more / total)."""
    ...
    def web_console(
        ...
        """Return recent browser console messages (check has_more / total)."""
    ...
    def web_scripts(
        ...
        """List parsed scripts seen by the debugger (check has_more / total)."""
        return _dump(
