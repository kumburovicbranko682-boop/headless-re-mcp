...
def build_web_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def web_console(
        ...
        and marked text_truncated. Uncaught page exceptions are captured too,
        as entries with type "exception", so a crashing page does not read as
        one that logged nothing wrong.
        """
