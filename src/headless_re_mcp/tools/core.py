...
def build_core_session_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def session_list(
        ...
        Check has_more / total: a full page is not every session this process has.
        """
...
def build_static_extended_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def static_segments(
        ...
        """List memory segments with names, ranges, and permissions (check has_more)."""
    ...
    def static_imports(
        ...
        """List imported symbols (module, name/ordinal, ea; check has_more / total)."""
    ...
    def static_exports(
        ...
        """List exported entries (check has_more / total)."""
    ...
    def static_entrypoints(
        ...
        """List entry points (start IP and IDA entry table; check has_more)."""
    ...
    def static_disassemble(
        ...
        """Bounded linear disassembly starting at address (check truncated)."""
        return _dump(
    ...
    def static_xrefs_to(
        ...
        """List cross-references to an address (check has_more / total)."""
        return _dump(
    ...
    def static_xrefs_from(
        ...
        """List cross-references from an address (check has_more / total)."""
        return _dump(
    ...
    def static_callers(
        ...
        """List call-type callers of the function containing address.

        Weak model; check has_more / total.
        """
        return _dump(
    ...
    def static_callees(
        ...
        """List call-type callees from the function containing address.
    ...
    def static_basic_blocks(
        ...
        """List basic blocks for the function containing address (check has_more)."""
        return _dump(
    ...
    def static_cfg(session_id: str, address: int) -> dict[str, Any]:
        """Return function-local CFG nodes and edges (check truncated)."""
    ...
    def static_globals(
        ...
        """List named addresses outside functions (best-effort globals; check has_more)."""
    ...
    def static_names(
        ...
        """List named addresses in the IDA database (check has_more)."""
    ...
    def static_types(
        ...
        """List local type-library ordinals (check has_more)."""
    ...
    def static_bytes_read(
        ...
        """Read a bounded byte range from the IDA database (check truncated)."""
    ...
    def static_search_bytes(
        ...
        """Search for a binary pattern (IDA bin-string syntax; check has_more)."""
        return _dump(
    ...
    def static_search_text(
        ...
        """Search for text in the IDA database (check has_more)."""
        return _dump(
