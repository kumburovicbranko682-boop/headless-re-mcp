...
def build_core_session_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def session_list(
        ...
        """List sessions; read has_more / total when the page is full."""
...
def build_static_core_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def static_functions(
        ...
        """List analyzed functions; read has_more / total when the page is full."""
    ...
    def static_strings(
        ...
        """List analyzed strings; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_decompile(
        ...
        """Decompile the function containing address, or the first when omitted.

        Empty code is not success.
        """
...
def build_static_extended_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def static_segments(
        ...
        """List memory segments; read has_more / total when the page is full."""
    ...
    def static_imports(
        ...
        """List imported symbols; read has_more / total when the page is full."""
    ...
    def static_exports(
        ...
        """List exported entries; read has_more / total when the page is full."""
    ...
    def static_disassemble(
        ...
        """Bounded linear disassembly; read truncated when a line was cut."""
        return _dump(
    ...
    def static_xrefs_to(
        ...
        """List cross-references to an address; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_xrefs_from(
        ...
        """List cross-references from an address; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_callers(
        ...
        """List call-type callers; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_callees(
        ...
        """List call-type callees; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_basic_blocks(
        ...
        """List basic blocks; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_cfg(session_id: str, address: int) -> dict[str, Any]:
        """Return function-local CFG nodes and edges; read has_more / total_nodes when cut."""
    ...
    def static_globals(
        ...
        """List named addresses outside functions; read has_more / total when the page is full."""
    ...
    def static_types(
        ...
        """List local type-library ordinals; read has_more / total when the page is full."""
    ...
    def static_structs(
        ...
        """List struct/union types; read has_more / total when the page is full."""
    ...
    def static_enums(
        ...
        """List enum types; read has_more / total when the page is full."""
    ...
    def static_search_bytes(
        ...
        """Search for a binary pattern; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_search_text(
        ...
        """Search for text; read has_more / total when the page is full."""
        return _dump(
    ...
    def static_search_immediate(
        ...
        """Search for an immediate operand; read has_more / total when the page is full."""
        return _dump(
