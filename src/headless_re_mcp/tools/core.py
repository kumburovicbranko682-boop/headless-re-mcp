...
def build_static_core_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def static_decompile(
        ...
        Oversized output is spilled to an artifact and marked truncated. Read
        those fields rather than treating code as the whole function; fetch
        the rest with artifacts.read.
        """
...
def build_static_extended_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def static_segments(
        ...
        Capped by limit. Read has_more and total rather than treating returned
        as every segment in the database.
        """
    ...
    def static_imports(
        ...
        Capped by limit. Read has_more and total rather than treating returned
        as every import in the database.
        """
    ...
    def static_exports(
        ...
        Capped by limit. Read has_more and total rather than treating returned
        as every export in the database.
        """
    ...
    def static_bytes_read(
        ...
        rather than treating a short buffer as the whole request.
        """
