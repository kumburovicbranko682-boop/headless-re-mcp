...
def build_windbg_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def windbg_threads(
        ...
        """Thread list of a crash dump, as cdb prints it (check truncated)."""
    ...
    def windbg_modules(
        ...
        """Loaded module list of a crash dump, as cdb prints it (check truncated)."""
    ...
    def windbg_disasm(
        ...
        """Disassemble length instructions at address inside a crash dump (check truncated)."""
    ...
    def windbg_live_threads(
        ...
        """Thread list of this session's live debuggee, read non-invasively (check truncated)."""
    ...
    def windbg_live_modules(
        ...
        """Loaded module list of this session's live debuggee (check truncated)."""
