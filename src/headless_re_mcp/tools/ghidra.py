...
def build_ghidra_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def ghidra_analyze(
        ...
        HEADLESS_RE_GHIDRA_HOME. Check truncated: the log excerpt is cut at
        8000 characters.
        """
    ...
    def ghidra_functions(
        ...
        """Functions Ghidra found, with address, size and name (check has_more)."""
    ...
    def ghidra_symbols(
        ...
        """Symbols Ghidra recovered, with address and namespace (check has_more)."""
    ...
    def ghidra_xrefs(
        ...
        """References to and from address, as Ghidra resolved them (check has_more)."""
