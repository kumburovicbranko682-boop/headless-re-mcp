...
def build_ghidra_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def ghidra_functions(
        ...
        """Functions Ghidra found; read has_more when the page is full."""
    ...
    def ghidra_symbols(
        ...
        """Symbols Ghidra recovered; read has_more when the page is full."""
    ...
    def ghidra_xrefs(
        ...
        """References to and from address; read has_more when the page is full."""
