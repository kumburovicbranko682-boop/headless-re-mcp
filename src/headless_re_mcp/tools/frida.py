...
def build_frida_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def frida_modules(
        ...
        """List mapped modules; read has_more / total when the page is full."""
    ...
    def frida_devices(limit: Annotated[int, Field(ge=1, le=256)] = 32) -> dict[str, Any]:
        """Enumerate Frida devices; read has_more / total when the page is full."""
        return _dump(analysis.frida_devices(limit=limit))
    ...
    def frida_applications(
        ...
        """List installed applications; read has_more / total when the page is full."""
    ...
    def frida_java_classes(
        ...
        """Enumerate loaded Java classes; read has_more when the page is full."""
        return _dump(
    ...
    def frida_java_methods(
        ...
        """List declared methods of a Java class; read has_more when the page is full."""
