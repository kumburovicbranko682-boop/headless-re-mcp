...
def build_frida_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def frida_modules(
        ...
        """List modules in the authorized process (check has_more / total)."""
    ...
    def frida_exports(
        ...
        """List exports of one module in the authorized process (check has_more)."""
    ...
    def frida_java_classes(
        ...
        """Enumerate loaded Java classes on the authorized device pid (check has_more)."""
        return _dump(
    ...
    def frida_java_methods(
        ...
        """List declared methods of a Java class on the authorized device pid (check has_more)."""
