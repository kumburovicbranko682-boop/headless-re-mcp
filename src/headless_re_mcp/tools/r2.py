...
def build_r2_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def r2_open(
        ...
        large sample a longer timeout. Check truncated: info is cut at 8000
        characters.
        """
    ...
    def r2_imports(
        ...
        """Imported symbols with the library each resolves to (check items_truncated)."""
    ...
    def r2_exports(
        ...
        """Exported symbols with their addresses (check items_truncated)."""
    ...
    def r2_disasm(
        ...
        Check truncated / items_truncated: raw output and the item list are
        both capped.
        """
    ...
    def r2_xrefs(
        ...
        """References to and from address, as radare2 resolved them (check items_truncated)."""
