...
def build_r2_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def r2_functions(
        ...
        (va/rva/module), plus count. There is no functions, truncated or
        has_more field. Read items_truncated, items_total and items_limit
        when the list filled the cap (4096).
        """
