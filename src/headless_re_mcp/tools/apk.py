...
def build_apk_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def apk_manifest(session_id: str) -> dict[str, Any]:
        ...
        Large manifests are cut; read truncated rather than treating the
        XML as the whole file.
        """
    ...
    def apk_permissions(
        ...
        as every permission the APK declared.
        """
    ...
    def apk_certificates(
        ...
        Capped; the reply carries total and has_more so a page is not read
        as every signer the APK shipped.
        """
    ...
    def apk_components(
        ...
        Each list is capped; the reply carries totals and has_more so a
        page is not read as every component the APK declared.
        """
