...
def build_apk_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def apk_permissions(
        ...
        every permission the APK declares.
        """
    ...
    def apk_components(
        ...
        Each list is capped by limit. Read has_more and totals rather than
        treating the returned names as every component in the APK.
        """
    ...
    def apk_classes(
        ...
        Read has_more and total rather than treating count as every class
        in the DEX.
        """
    ...
    def apk_methods(
        ...
        Read has_more and total rather than treating count as every method
        on the class.
        """
        return _dump(
    ...
    def apk_decompile(
        ...
        jadx can exit non-zero after writing a usable class. Read partial and
        exit_code rather than treating the source as a clean decompile.
        """
    ...
    def apk_export_sources(
        ...
        The file list is capped. Read has_more and java_file_count rather than
        treating java_files as every class. jadx can exit non-zero after
        writing a usable tree: read partial and exit_code rather than treating
        the tree as a clean decompile.
        """
        return _dump(
