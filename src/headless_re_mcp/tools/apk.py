...
def build_apk_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def apk_manifest(session_id: str) -> dict[str, Any]:
        """Return the decoded AndroidManifest.xml; read truncated if it was cut."""
    ...
    def apk_permissions(
        ...
        """List declared and requested permissions; read has_more / totals when the page is full."""
        return _dump(analysis.apk_permissions(session_id, limit=limit))

    @tools.tool(name="apk.certificates")
    def apk_certificates(
        session_id: str, limit: Annotated[int, Field(ge=1, le=200)] = 50
    ) -> dict[str, Any]:
        """List signing certificates; read has_more / totals when the page is full."""
    ...
    def apk_components(
        ...
        """List activities, services, receivers, and providers; read has_more / totals."""
    ...
    def apk_native_libs(
        ...
        """List bundled native libraries; read has_more / total when the page is full."""
    ...
    def apk_classes(
        ...
        """List internal DEX classes; read has_more / total when the page is full."""
    ...
    def apk_methods(
        ...
        """List methods of a class; read has_more / total when the page is full."""
        return _dump(
    ...
    def apk_strings(
        ...
        """List distinct DEX strings; read has_more / total when the page is full."""
    ...
    def apk_xrefs(
        ...
        """List callers of methods named method_name; read has_more when the page is full."""
    ...
    def apk_export_sources(
        ...
        """Decompile the whole APK to Java sources; read has_more if the file list was cut."""
        return _dump(
