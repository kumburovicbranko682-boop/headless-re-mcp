...
def build_device_tools(analysis: AnalysisService) -> tuple[BoundTool, ...]:
    ...
    def device_info(serial: str) -> dict[str, Any]:
        """Return model, SDK, release, and ABI; an adb error line is not a model."""
    ...
    def device_properties(
        ...
        """Return getprop pairs; an adb error line is not an empty property set."""
    ...
    def device_install(
        ...
        """Install a local APK; installed is True only when pm did not print Failure."""
    ...
    def device_force_stop(serial: str, package: str) -> dict[str, Any]:
        """Force-stop a running package; stopped is True only when am printed no Error."""
    ...
    def device_logcat(
        ...
        """Return the last N lines of logcat; an adb error line is not a snapshot."""
