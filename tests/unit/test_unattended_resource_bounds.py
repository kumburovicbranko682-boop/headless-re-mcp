...
class TestGhidraExportDisclosesTruncation:
    def test_the_headless_script_marks_cut_lists_and_cut_decompilation(self) -> None:
        ...
        # The postScript is a Java GhidraScript (Ghidra 11.3 dropped the bundled
        # Jython): a cut listing sets hasMore, and the decompilation is clamped
        # to the same 200000-char ceiling the client documents.
        assert "hasMore = true;" in text
        assert "text.length() > MAX_DECOMPILED" in text
