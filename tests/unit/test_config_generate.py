...
def _poisoned_report(*, ready: bool):
    ...
    # platform-dependent -- Linux wants {platform, python}, Windows adds
    # ida_idalib and x64dbg_headless_binaries -- so cover the union here to keep
    # the fixture ready on whichever host runs it.
    return DoctorReport(
        probes=(
            leaky,
