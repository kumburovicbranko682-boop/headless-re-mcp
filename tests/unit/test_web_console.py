...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates the native dialog behind is_windows_host(); force it on
    # for this route only, rather than mutating the process-wide os module,
    # which would make pathlib try to build a WindowsPath on Linux.
