...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates the native dialog on is_windows_host(), so pretend this is
    # a Windows host without mutating the process-wide os module (which would make
    # pathlib build a WindowsPath on Linux).
