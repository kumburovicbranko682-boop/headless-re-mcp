...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates the native dialog on is_windows_host(); fake that for
    # this route rather than os.name, which would make pathlib build a
    # WindowsPath on this Linux host.
