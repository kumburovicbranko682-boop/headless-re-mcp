...
def test_web_pick_file_returns_a_local_path(
    ...
    # Patch the route module's imported platform check rather than os.name:
    # mutating Python's process-wide os module makes pathlib try to construct
    # WindowsPath on Linux. Only this route should see a Windows host.
