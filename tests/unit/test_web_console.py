...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates on is_windows_host(), not os.name, so patching that lets
    # the Windows-only picker path run on Linux without mutating the process
    # os module (which would make pathlib build a WindowsPath and break here).
