...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates on is_windows_host(); fake a Windows host by patching the
    # name the route resolves, rather than mutating the process-wide os module
    # (which would make pathlib build WindowsPath on Linux).
