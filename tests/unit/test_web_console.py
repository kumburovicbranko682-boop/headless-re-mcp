...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates on is_windows_host() rather than a raw os.name check, so a
    # Windows-shaped os module no longer reaches it. Force the host predicate the
    # route actually consults, which also avoids mutating the process-wide os.
