...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates on the module-level is_windows_host import, not os.name,
    # so patch that binding rather than mutating the process-wide os module
    # (which would make pathlib construct WindowsPath on Linux).
