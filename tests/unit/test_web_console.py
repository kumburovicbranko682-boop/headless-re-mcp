...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route decides availability with is_windows_host(), not os.name, so
    # pretend this host is Windows for that call alone -- flipping os.name would
    # make pathlib build a WindowsPath from a POSIX string on Linux.
