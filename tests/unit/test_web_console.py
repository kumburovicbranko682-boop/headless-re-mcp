...
def test_web_pick_file_returns_a_local_path(
    ...
    # The route gates the native dialog on is_windows_host(); pretend this is a
    # Windows host so the dialog path runs without mutating the process-wide os
    # module (which would make pathlib build WindowsPath on Linux).
