...
def test_a_probe_less_capability_reports_ready() -> None:
    """The None branch is a real code path even when no capability uses it."""
...
def test_list_capabilities_maps_probe_status_and_honors_filters(
    ...
    # ui.win32 now carries a real win32_ui probe (Linux reports it unsupported);
    # a ready probe surfaces as ready.
