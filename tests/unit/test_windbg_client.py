...
def test_live_threads_description_says_to_read_truncated() -> None:
    """windbg.live_threads already cuts output but its tool text never said so.
    ...
    field treated a cut thread list as every thread.
    """
