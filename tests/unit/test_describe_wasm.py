...
module's own section table for the version, present sections, and vector counts
that identify it -- the WASM analogue of describe_apk. These cover the counts,
the fail-closed behaviour on a malformed tail, and that non-WASM inputs return
