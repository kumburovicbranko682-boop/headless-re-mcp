...
def test_a_screenshot_loop_cannot_grow_the_device_directory_without_bound(
    ...
    which device_screenshot enforces through prune_capped_dir with the shared
    UNREGISTERED_CAPTURE_MAX_ENTRIES cap -- not the count-only helper this file
    used to pin, which the live path stopped calling.
    """
