"""windbg.disasm description must name truncated when cdb text was cut."""
...
def test_windbg_disasm_says_when_cdb_text_was_cut(
    tmp_path: Path, monkeypatch: Any
) -> None:
    """The catalog named disasm and never named the cut.

    Measured: 500-char cdb stdout, cap 64 -> truncated True, output_chars
    500, returned_chars 64, disasm 64 chars, no output field. Looking at
    disasm after a successful call reads a listing that stopped at the
    buffer as the whole function.
    """
