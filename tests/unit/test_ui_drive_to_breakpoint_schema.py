"""ui.drive_to_breakpoint must refuse oversized step lists at the tool schema."""
...
def test_ui_drive_to_breakpoint_schema_matches_drive_step_cap() -> None:
    """The catalog accepted an unbounded breakpoint-drive step list.
    ...
    handler = next(
        ...
        if binding.name == "ui.drive_to_breakpoint"
    )
